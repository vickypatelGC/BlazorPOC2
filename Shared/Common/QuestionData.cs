    ...
    public static class QuestionData
    {
        ...
        public static List<Question> GetQuestions()
        {
            List<Question> Questions = new List<Question> {
              ...
              new Question { QuestionId = 5 ,  Text = "What's your blood pressure?" , Type = QuestionType.SelectOne , Options =new List<QuestionOption> { new QuestionOption { Text = "Normal (Between 90/60 - 140/90) ", Sequance = 1 , OptionId = 1 } , new QuestionOption { Text = "Low (Below 90/60) ", Sequance = 2, OptionId = 2 },  new QuestionOption { Text = "High (Above 140/90) ", Sequance = 3 , OptionId = 3 }, new QuestionOption { Text = "I don’t know", Sequance = 4, OptionId = 4 } } },
