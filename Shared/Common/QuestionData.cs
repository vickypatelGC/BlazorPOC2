    ...
    public static class QuestionData
    {
        ...
        public static List<Question> GetQuestions()
        {
            List<Question> Questions = new List<Question> {
              ...
              new Question { QuestionId = 1 ,  Text = "How often do you get erection problems during sex?" , Type = QuestionType.SelectOne , Options =new List<QuestionOption> { new QuestionOption { Text = "Most or all of the time" , Sequance = 1 , OptionId = 1 ,FollowUpQuestion = new Question { QuestionId = 16, Text = "Additional information", Type = QuestionType.Textarea } } , new QuestionOption { Text = "Sometimes", Sequance = 2, OptionId = 2 }, new QuestionOption { Text = "Rarely or never", Sequance = 3, OptionId = 3, FollowUpQuestion =new Question { QuestionId = 6 ,  Text = "Was your blood pressure checked in the last year?" , Type = QuestionType.SelectOne , Options =new List<QuestionOption> { new QuestionOption { Text = "Yes", Sequance = 1 , OptionId = 1 } , new QuestionOption { Text = "No", Sequance = 2, OptionId = 2 } } }  } } },
